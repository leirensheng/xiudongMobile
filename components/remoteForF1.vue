<template>
  ...
  ></set-time>
  <my-terminal v-if="showPid" :platform="'f1'" v-model:pid="showPid" />
</template>
...
export default {
  ...
  data() {
    return {
      skuIdToTypeMap: {
        "675b9f32b8f2ff00012b5086":
          "Grandstand A_2025-03-22周六 SAT_A上 周六票/A HIGH SAT. TICKET",
        "675b9f32b8f2ff00012b5087":
          "Grandstand A_2025-03-22周六 SAT_A下 周六票/A LOW SAT. TICKET",
        "675b9f32b20197000162fbbb":
          "Grandstand A_3 DAY TICKET_A上 三日票/A HIGH  3 DAY TICKET",
        "675b9f32b20197000162fbbc":
          "Grandstand A_3 DAY TICKET_A下 三日票/A LOW 3 DAY TICKET",
        "67ac86e95637b10001b5ecc3": "Grandstand A_3 DAY TICKET_A上快通礼遇",
        "67ac87575637b10001b5f591":
          "Grandstand A_3 DAY TICKET_A上快通礼遇（2人）",
        "67ac87955637b10001b5fabf":
          "Grandstand A_3 DAY TICKET_A上快通礼遇（3人）",
        "67ac87c35637b10001b5ff1f":
          "Grandstand A_3 DAY TICKET_A上快通礼遇（4人）",
        "675b9f32c453ee0001c05964":
          "Grandstand A_2025-03-21周五 FRI_A上 周五票/A HIGH FRI. TICKET",
        "675b9f32c453ee0001c05965":
          "Grandstand A_2025-03-21周五 FRI_A下 周五票/A LOW FRI. TICKET",
        "675b9f32efc1280001eb2a3a":
          "Grandstand A_2025-03-23周日 SUN_A上 周日票/A HIGH SUN. TICKET",
        "675b9f32efc1280001eb2a3b":
          "Grandstand A_2025-03-23周日 SUN_A下 周日票/A LOW SUN. TICKET",
        "675b9f90f45aae0001dd334a":
          "Grandstand B_2025-03-23周日 SUN_周日票/SUN. TICKET",
        "675b9f91ccc15a0001001fe1":
          "Grandstand B_3 DAY TICKET_B 三日票/B 3 DAY TICKET",
        "675b9f91ccc15a0001001fe2":
          "Grandstand B_3 DAY TICKET_B尊享 三日票/B PREMIUM 3 DAY TICKET",
        "675b9f91b8f2ff00012b5102":
          "Grandstand B_2025-03-22周六 SAT_周六票/SAT. TICKET",
        "675b9f900d937200015b3462":
          "Grandstand B_2025-03-21周五 FRI_周五票/FRI. TICKET",
        "675b9f81f45aae0001dd332c":
          "Grandstand K_3 DAY TICKET_K 三日票/K 3 DAY TICKET",
        "675b9f82efc1280001eb2a9c":
          "Grandstand K_2025-03-21周五 FRI_K 周五票/K  FRI. TICKET",
        "675b9f820aac1200012aebcb":
          "Grandstand K_2025-03-23周日 SUN_K 周日票/K  SUN. TICKET",
        "675b9f820b4c750001e729df":
          "Grandstand K_2025-03-22周六 SAT_K 周六票/K SAT. TICKET",
        "675b9f666087d80001c5ab93":
          "Grandstand H_2025-03-23周日 SUN_H 周日票/H  SUN. TICKET",
        "675b9f660aac1200012aeba4":
          "Grandstand H_2025-03-22周六 SAT_H 周六票/H  SAT. TICKET",
        "675b9f6691dd1e0001100e80":
          "Grandstand H_2025-03-21周五 FRI_H 周五票/H  FRI. TICKET",
        "675b9f660d937200015b342b":
          "Grandstand H_3 DAY TICKET_H 三日票/H 3 DAY TICKET",
        "675b9f55c453ee0001c05998":
          "Grandstand A-PLATINUM_3 DAY TICKET_A铂金三日票/A PLATINUM 3 DAY TICKET",
        "675b9f450aac1200012aeb73":
          "Grass Area_3 DAY TICKET_ C三日票 3 DAY TICKET",
        "675b9f450aac1200012aeb74":
          "Grass Area_3 DAY TICKET_ J三日票 3 DAY TICKET",
        "675b9f450aac1200012aeb75":
          "Grass Area_3 DAY TICKET_ F三日票 3 DAY TICKET",
      },
  ...
  methods: {
    ...
    async confirmEdit() {
      ...
      if (form.showOrders) {
        form.orders = form.showOrders.split(",").map((one) => Number(one));
      } else {
        form.price = [];
      }
      delete form.showOrders;
      let data = {
    ...
    async add() {
      ...
      data.orders = this.form.showOrders.split(",").map((one) => Number(one));
      delete data.showOrders;
      // todo
      ...
      let arr = ["phone", "username", "targetTypes"];
    ...
    async openCopyDialog({ activityId, port, typeMap, activityName }) {
      if (this.isDamai) {
    ...
    async getConfig(isFirst) {
      ...
      try {
        ...
        let p2 = request({
          url: this.host + "/getAllAudienceInfo",
          cancelPre: true,
        });
        let [{ config, pidToCmd }, audienceInfo] = await Promise.all([p1, p2]);
        ...
        data.forEach((one) => {
          ...
          one.cmd = cmd;
          one.showOrders = one.orders ? one.orders.join(",") : "";
          one.loading = false;
